...
class ProductPage(BasePage):
    def add_product_to_basket(self):
        ...
        basket = WebDriverWait(self.browser, 50).until(EC.visibility_of_element_located(ProductPageLocators.
    ...
    def should_be_product_name_in_message(self):
        product_name = WebDriverWait(self.browser, 50).until(EC.visibility_of_element_located(ProductPageLocators.
                                                                                              PRODUCT_NAME))

        product_message = WebDriverWait(self.browser, 50).until(EC.visibility_of_element_located
                                                                (ProductPageLocators.
    ...
    def should_be_product_price_in_message(self):
        product_price = WebDriverWait(self.browser, 50).until(EC.visibility_of_element_located
                                                              (ProductPageLocators.PRODUCT_PRICE))
        price_message = WebDriverWait(self.browser, 50).until(EC.visibility_of_element_located
